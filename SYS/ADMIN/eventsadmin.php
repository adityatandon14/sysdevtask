...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./eventsadmin.css">
    <div class="ro">
...
<body>
   ...
   <h1>we'll be conducting a workshop on github from 10 am to 12pm on TTS</h1>
	...
	<h1>
		We'll be conducting a gameing competition on Sunday
	 </h1>
	...
	<div class="android">
	 ...
	 <form action="process.php" METHOD = "POST">
		...
		<input type="text" id="image" name="eventname"><br><br>
		<label for="lname">description:</label>
		<input type="text" id="description" name="Details"><br><br>
		<input type="submit" value="Submit" name="submit">
	  </form>
	  <button type="button">Click here to add this</button>
  </div>
 <form action="logout.php" METHOD = "POST">
      <button type="button" name = "Submit" align="bottom-right ">click here to Logout</button>
    </form>
